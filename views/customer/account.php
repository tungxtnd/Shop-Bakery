...
if (isset($_POST['update_profile'])) {
    ...
    if ($full_name === '')
        $edit_errors[] = "Full name cannot be empty.";
        ...
        <div class="container" style="margin-left:220px;">
            ...
            <div class="profile-info">
                ...
                <form method="post" class="info-table" autocomplete="off">
                    <?php if ($edit_errors): ?>
                        <div class="error-list"><?php foreach ($edit_errors as $e)
                            echo "<div>$e</div>"; ?></div>
                    <?php endif; ?>
                    <?php if ($edit_success): ?>
            ...
            <div class="profile-actions">
                <button type="button" id="show-change-pass" class="btn btn-secondary" style="margin-left:12px;"
                    aria-expanded="false">Change Password</button>
            </div>
            <div class="form-section<?php if ($show_change_pass || $pass_errors || $pass_success)
                echo ' active'; ?>"
                id="change-pass-section">
                <form method="post" autocomplete="off">
                    <div class="form-title">Change Password</div>
                    <?php if ($pass_errors): ?>
                        <div class="error-list"><?php foreach ($pass_errors as $e)
                            echo "<div>$e</div>"; ?></div>
                    <?php endif; ?>
                    <?php if ($pass_success): ?>
