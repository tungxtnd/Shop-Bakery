...
<head>
    ...
    <style>
        ...
        .form-group input:focus {
            border-color: #b97a56;
            outline: none;
            box-shadow: 0 0 5px rgba(185, 122, 86, 0.2);
        }
    ...
    <div class="main-wrapper">
        ...
        <div class="content">
            <div class="profile-card">
                <h2 style="color: #333; margin-top: 0; margin-bottom: 25px; text-align: center;">Personal Information
                </h2>
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label><i class="fa-solid fa-user-shield"></i> Role (Read-only)</label>
