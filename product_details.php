...
<body>
    ...
    <a href="/product_details.php?id=<?php echo $product_id; ?>" style="text-decoration: none; color: #000;"><?php echo htmlspecialchars($product['name']); ?></a>
                ...
                <div class="card">
                    <?php foreach ($cards as $card): ?>
                        <label data-card-id="<?php echo $card['id']; ?>" style="text-align:center; display:inline-block; border-radius:2px;">
                            <input type="radio" name="card" value="<?php echo $card['id']; ?>" data-card-price="<?php echo $card['price']; ?>">
                            <div>
