    ...
    <div class="product-detail-left">
        ...
        <div class="thumbnail-gallery"
            ...
            <?php foreach ($gallery_images as $index => $img_name): ?>
                <img src="/assets/img/<?php echo htmlspecialchars($img_name); ?>"
                     ...
                     style="width:55px; height:55px; margin:0 !important; display:block; flex-shrink:0;
        ...
        <div style="margin-top:40px;">
            ...
            <div style="margin-bottom:18px;">
                ...
                <?php for ($i = 1; $i <= 5; $i++): ?>
                    <span style="color:<?php echo $i <= round($avg_rating) ? '#f7b731' : '#ddd'; ?>; font-size:1.2em;">&#9733;</span>
                <?php endfor; ?>
            ...
            <?php if ($review_result && $review_result->num_rows > 0): ?>
                <?php while ($review = $review_result->fetch_assoc()): ?>
                    <div style="border-bottom:1px solid #eee; padding:14px 0;">
                        <div>
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <span style="color:<?php echo $i <= $review['rating'] ? '#f7b731' : '#ddd'; ?>; font-size:1.1em;">&#9733;</span>
                            <?php endfor; ?>
    ...
    <div class="product-detail-right">
        ...
        <form method="post" id="cart-form">
            ...
            <input type="submit" name="add_to_cart" value="🛒 Add to Cart"
                   style="width:30%; background-color:#9d503b; color:white; padding:14px 20px;
                          border:none; border-radius:4px; cursor:pointer;">

            <button type="button" id="checkout-btn"
                    style="width:30%; background-color:#840000; color:white; padding:14px 20px;
