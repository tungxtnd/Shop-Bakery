...
-- Dumping data for table ql_bakery.cart_items: ~6 rows (approximately)
...
-- Dumping data for table ql_bakery.notifications: ~104 rows (approximately)
INSERT INTO `notifications` (`id`, `user_id`, `target_user_id`, `product_id`, `order_id`, `type`, `message`, `created_at`) VALUES
	...
	(112, 4, 4, NULL, NULL, 'login', 'You have logged in successfully.', '2026-04-11 10:12:50'),
	(113, 4, 4, NULL, 51, 'order_status', 'Your order #51 has been placed and is pending confirmation.', '2026-04-11 10:13:08'),
	(114, 4, 4, NULL, NULL, 'login', 'You have logged in successfully.', '2026-04-11 10:13:43'),
	(115, 4, 4, NULL, 52, 'order_status', 'Your order #52 has been placed and is pending confirmation.', '2026-04-11 10:13:57'),
	(116, 4, 4, NULL, NULL, 'logout', 'You have logged out.', '2026-04-11 10:15:02'),
	(117, 4, 4, NULL, NULL, 'login', 'You have logged in successfully.', '2026-04-11 10:15:09'),
	(118, 4, 4, NULL, NULL, 'logout', 'You have logged out.', '2026-04-11 10:16:38'),
	(119, 10, 10, NULL, NULL, 'login', 'You have logged in successfully.', '2026-04-11 10:17:19'),
	(120, 10, 10, NULL, NULL, 'login', 'You have logged in successfully.', '2026-04-11 10:21:44'),
	(121, 10, 10, NULL, 53, 'order_status', 'Your order #53 has been placed and is pending confirmation.', '2026-04-11 10:53:41'),
	(122, 10, 10, NULL, 54, 'order_status', 'Your order #54 has been placed and is pending confirmation.', '2026-04-11 11:06:27'),
	(123, 10, 10, NULL, 55, 'order_status', 'Your order #55 has been placed and is pending confirmation.', '2026-04-11 11:06:35');
...
INSERT INTO `orders` (`id`, `user_id`, `total_amount`, `order_date`, `status`) VALUES
	...
	(51, 4, 0.00, '2026-04-11 10:13:08', 'Pending'),
	(52, 4, 480000.00, '2026-04-11 10:13:57', 'Pending'),
	(53, 10, 620000.00, '2026-04-11 10:53:41', 'Pending'),
	(54, 10, 1650000.00, '2026-04-11 11:06:27', 'Pending'),
	(55, 10, 490000.00, '2026-04-11 11:06:35', 'Pending');
...
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `quantity`, `price`, `service_id`, `card_message`) VALUES
	...
	(51, 51, 1, 1, 450000.00, NULL, ''),
	(52, 52, 1, 1, 450000.00, NULL, ''),
	(53, 53, 6, 1, 600000.00, NULL, ''),
	(54, 54, 6, 1, 600000.00, NULL, ''),
	(55, 55, 4, 1, 470000.00, NULL, '');
...
INSERT INTO `products` (`id`, `name`, `description`, `price`, `image`, `collection_id`, `stock`, `status`, `created_at`, `edit_at`) VALUES
	(1, 'Cheesecake', 'No-bake cheesecake with cream cheese & soy, salted egg yolk sauce, lemon sauce, gluten-free Mirliton bread.', 450000.00, 'opla-no-bake-cheesecake-234811.webp', 2, 0, 'in_stock', '2025-11-01 13:00:21', NULL),
	...
	(4, 'Fresh Buttercream Cake', 'Fresh avocado mousse, avocado sauce, soft roll cake, egg custard cream, caramelized cashews & roasted cocoa beans, chocolate cherries, passion fruit caramel.', 470000.00, 'BIRTHDAYREBIRTH9020_2.webp', 3, 1, 'in_stock', '2025-11-01 13:00:21', NULL),
	...
	(6, 'Orchid Grace', 'Graceful orchids in a delicate arrangement.', 600000.00, 'cannele-203299.webp', 2, 3, 'in_stock', '2025-11-01 13:00:21', NULL),
...
-- Dumping data for table ql_bakery.product_images: ~32 rows (approximately)
...
-- Dumping data for table ql_bakery.users: ~8 rows (approximately)
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `phone`, `address`, `role`) VALUES
	...
	(10, 'linh nguyen', 'linh2@gmail.com', '$2y$10$RmzQeA2JyXHEWCEOGs7m5eglaGZBaRTSwNbgcUV2D0THM4PX6yqEq', '0865786558', 'HaNoi', 'customer'),
...
-- Dumping data for table ql_bakery.work_schedules: ~0 rows (approximately)
